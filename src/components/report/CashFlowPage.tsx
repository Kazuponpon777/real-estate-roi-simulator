    ...
    return (
        <div className="report-page flex flex-col">
            ...
            <div className="flex justify-between items-end mb-4 border-b-2 border-blue-600 pb-2 flex-shrink-0">
                <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">キャッシュフロー詳細</h2>
                <p className="text-blue-400 text-[10px] uppercase tracking-widest">Page 0{pageNumber} — {startYear}〜{endYear}年目</p>
            </div>
                ...
                <table className="w-full text-[9px] text-right border-collapse">
                    <thead>
                        <tr className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[8px] uppercase tracking-wider">
                            <th className="py-1.5 px-1 text-center border-r border-blue-500/30 w-6 rounded-tl-lg">年</th>
                            <th className="py-1.5 px-1 border-r border-blue-500/30">実効収入</th>
                            <th className="py-1.5 px-1 border-r border-blue-500/30">運営費</th>
                            <th className="py-1.5 px-1 border-r border-blue-500/30 bg-blue-700/30">営業純利益</th>
                            <th className="py-1.5 px-1 border-r border-blue-500/30">返済額</th>
                            <th className="py-1.5 px-1 border-r border-blue-500/30 bg-blue-700/30">税引前CF</th>
